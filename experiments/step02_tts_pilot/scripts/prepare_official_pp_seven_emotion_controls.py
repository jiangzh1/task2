#!/usr/bin/env python3
"""Prepare one official PP-compatible control for each emotion."""
...
OUT = STEP / "artifacts" / "official_pp_seven_emotion_controls.ready.jsonl"
...
def main() -> None:
    ...
    for raw_line in SOURCE.read_text(encoding="utf-8").splitlines():
        ...
        if record.get("emotion") in EMOTIONS and record["emotion"] not in chosen:
            chosen[record["emotion"]] = record
    ...
    with ZipFile(REF_ZIP) as archive:
        ...
        for emotion in EMOTIONS:
            ...
            record["key"] = f"official_pp_{emotion}_control"
    ...
    (STEP / "artifacts" / "official_pp_seven_emotion_controls.manifest.json").write_text(
