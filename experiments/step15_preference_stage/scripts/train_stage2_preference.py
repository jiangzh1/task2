...
def main():
    ...
    reasoner=SpeechTextConflictReasoner(768,768,25,768).to(device); conditioner=ConflictAwareConditioner(256,256,64,codebook_size=args.codebook_size).to(device); load_stage1(args.stage1_checkpoint,reasoner,conditioner); freeze_modules((reasoner,conditioner))
